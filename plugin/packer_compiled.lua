...
_G.packer_plugins = {
  ...
  ["bufdelete.nvim"] = {
    loaded = true,
    path = "/Users/jdelcioppio.cont/.local/share/nvim/site/pack/packer/start/bufdelete.nvim"
  },
  ["dracula.nvim"] = {
    loaded = true,
  ...
  ["gitsigns.nvim"] = {
    config = { "\27LJ\2\nä\b\0\0\5\0\n\0\r6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0005\3\4\0005\4\5\0=\4\6\0035\4\a\0=\4\b\3=\3\t\2B\0\2\1K\0\1\0\fkeymaps\tn [h\1\2\1\0@&diff ? '[c' : '<cmd>lua require\"gitsigns\".prev_hunk()<CR>'\texpr\2\tn ]h\1\2\1\0@&diff ? ']c' : '<cmd>lua require\"gitsigns\".next_hunk()<CR>'\texpr\2\1\0\f\17n <leader>gp2<cmd>lua require\"gitsigns\".preview_hunk()<CR>\17n <leader>gr0<cmd>lua require\"gitsigns\".reset_hunk()<CR>\17v <leader>grT<cmd>lua require\"gitsigns\".reset_hunk({vim.fn.line(\".\"), vim.fn.line(\"v\")})<CR>\17n <leader>gU8<cmd>lua require\"gitsigns\".reset_buffer_index()<CR>\17v <leader>gsT<cmd>lua require\"gitsigns\".stage_hunk({vim.fn.line(\".\"), vim.fn.line(\"v\")})<CR>\17n <leader>gu5<cmd>lua require\"gitsigns\".undo_stage_hunk()<CR>\to ih2:<C-U>lua require\"gitsigns\".select_hunk()<CR>\17n <leader>gS2<cmd>lua require\"gitsigns\".stage_buffer()<CR>\tx ih2:<C-U>lua require\"gitsigns\".select_hunk()<CR>\17n <leader>gs0<cmd>lua require\"gitsigns\".stage_hunk()<CR>\17n <leader>gR2<cmd>lua require\"gitsigns\".reset_buffer()<CR>\fnoremap\2\1\0\3 current_line_blame_position\beol\23current_line_blame\2\24attach_to_untracked\1\nsetup\rgitsigns\frequire\0" },
    loaded = true,
  ...
  ["lsp_signature.nvim"] = {
    loaded = true,
    path = "/Users/jdelcioppio.cont/.local/share/nvim/site/pack/packer/start/lsp_signature.nvim"
  },
  ["lspsaga.nvim"] = {
  ...
  ["nvim-ts-autotag"] = {
    loaded = true,
    path = "/Users/jdelcioppio.cont/.local/share/nvim/site/pack/packer/start/nvim-ts-autotag"
  },
  ["nvim-web-devicons"] = {
    loaded = true,
